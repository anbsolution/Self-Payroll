...
class NoOpSecureApi : SyncApi {
    override suspend fun uploadProfile(profile: EmployeeProfileEntity) { throw java.io.IOException("Remote API endpoint is not configured") }
    override suspend fun uploadAttendance(attendance: AttendanceEntity) { throw java.io.IOException("Remote API endpoint is not configured") }
    override suspend fun uploadSalary(salary: SalarySlipEntity) { throw java.io.IOException("Remote API endpoint is not configured") }
}
